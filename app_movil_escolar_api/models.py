...
class EventosAcademicos(models.Model):
    ...
    tipo_evento = models.CharField(max_length=255, null=True, blank=True) # Campo select
    fecha_realizacion = models.DateField()
    hora_inicio = models.TimeField()
    hora_fin = models.TimeField()
    lugar = models.CharField(max_length=200)
    publico_objetivo = models.TextField(null=True, blank=True) # Checkboxes
    programa_educativo = models.CharField(max_length=255, blank=True, null=True) # Mat-select\lista-desplegable ;Solo si son estudiantes
    ...
    def __str__(self):
        return "Evento Academico " +self.nombre_evento+ " Tipo: " +self.tipo_evento